        ...
        <div class="row">
         <div class="col-md-6">
          <div class="form-group">
           ...
           <input type="number" name="nip" value="{{ old('ktp', $pegawai->nip) }}" class="form-control" required />
          </div>
         </div>
         <div class="col-md-6">
          <div class="form-group">
           <label for="nama">Nama</label>
           <input type="nama" name="nama" value="{{ old('nama', $pegawai->nama) }}" class="form-control" required />
          </div>
         </div>
